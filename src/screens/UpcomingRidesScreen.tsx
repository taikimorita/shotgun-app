...
const styles = StyleSheet.create({ page: { backgroundColor: "#F9FAFB", flexGrow: 1, gap: 12, padding: 20, paddingTop: 64 }, header: { alignItems: "flex-start", flexDirection: "row", justifyContent: "space-between", marginBottom: 8 }, title: { color: "#111827", fontSize: 28, fontWeight: "800" }, subtitle: { color: "#6B7280", marginTop: 4 }, link: { color: "#1D4ED8", fontWeight: "800", paddingTop: 8 }, status: { marginLeft: 12, marginTop: -24 }, empty: { alignItems: "center", backgroundColor: "#FFF", borderRadius: 16, gap: 10, marginTop: 16, padding: 30 }, emptyTitle: { color: "#111827", fontSize: 17, fontWeight: "800" }, primary: { backgroundColor: "#1D4ED8", borderRadius: 10, marginTop: 8, paddingHorizontal: 16, paddingVertical: 12 }, primaryText: { color: "#FFF", fontWeight: "800" }, browse: { alignItems: "center", borderColor: "#BFDBFE", borderRadius: 12, borderWidth: 1, marginTop: 4, padding: 14 }, browseText: { color: "#1D4ED8", fontWeight: "800" } });
